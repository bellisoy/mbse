...
/**
 * This is the item provider adapter for a {@link de.tu_bs.cs.isf.mbse.recipe.Machine} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MachineItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addNeededInPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RecipePackage.Literals.MACHINE__NAME,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Needed In feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addNeededInPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Machine_neededIn_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Machine_neededIn_feature", "_UI_Machine_type"),
				 RecipePackage.Literals.MACHINE__NEEDED_IN,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addPurposePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Machine_purpose_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Machine_purpose_feature", "_UI_Machine_type"),
				 RecipePackage.Literals.MACHINE__PURPOSE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
