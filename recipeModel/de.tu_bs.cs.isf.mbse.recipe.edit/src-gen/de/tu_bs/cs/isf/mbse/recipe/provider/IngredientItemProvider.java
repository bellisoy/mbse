...
/**
 * This is the item provider adapter for a {@link de.tu_bs.cs.isf.mbse.recipe.Ingredient} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RecipePackage.Literals.INGREDIENT__QUANTITY,
				 true,
				 false,
				 false,
	...
	protected void addUnitPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Ingredient_unit_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Ingredient_unit_feature", "_UI_Ingredient_type"),
				 RecipePackage.Literals.INGREDIENT__UNIT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addPricePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Ingredient_price_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Ingredient_price_feature", "_UI_Ingredient_type"),
				 RecipePackage.Literals.INGREDIENT__PRICE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Ingredient_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Ingredient_type_feature", "_UI_Ingredient_type"),
				 RecipePackage.Literals.INGREDIENT__TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addContainedInPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Ingredient_containedIn_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Ingredient_containedIn_feature", "_UI_Ingredient_type"),
				 RecipePackage.Literals.INGREDIENT__CONTAINED_IN,
				 true,
				 false,
				 true,
				 null,
